          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>A source of millions of jobs.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>A user friendly interface to provide good experience and easy job search.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>A top career opurtunity platform providing high end jobs.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>A platform comprising geniune expertised candidates.</p>
              </div>
            </div>      
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">The job portal revolutionized our recruitment process. With its user-friendly interface and extensive database, we found top talent swiftly, enhancing project efficiency and achieving remarkable milestones. A game-changer indeed!</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">The job portal's intuitive interface and seamless navigation greatly simplified my job search. Its modern design and robust features ensured a delightful user experience, facilitating my career advancement effortlessly. Highly recommended!</p>
                    <p class="name">Steve Roger</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">The job portal's intuitive interface and seamless navigation greatly simplified my job search. Its modern design and robust features ensured a delightful user experience, facilitating my career advancement effortlessly. Highly recommended!</p>
                    <p class="name">Franchis Muller</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">The job portal's comprehensive platform provided invaluable insights into the job market. Its advanced search capabilities and precise filtering options enabled me to find the perfect fit for my skill set effortlessly.</p>
                    <p class="name">Curnil Sten</p>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('./plugins/jobportal/images/image_1.jpg');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">June 5, 2024</a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
                </div>
                <h3 class="heading"><a href="#">Blog 1</a></h3>
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('./plugins/jobportal/images/image_2.jpg');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">June 5, 2024</a></div>
                ...
                <h3 class="heading"><a href="#">Blog 2</a></h3>
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('./plugins/jobportal/images/image_3.jpg');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">June 5, 2024</a></div>
                ...
                <h3 class="heading"><a href="#">Blog 3</a></h3>
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('./plugins/jobportal/images/image_4.jpg');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">June 5, 2024</a></div>
                ...
                <h3 class="heading"><a href="#">Blog 4</a></h3>
